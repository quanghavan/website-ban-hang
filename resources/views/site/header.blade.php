        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a style="text-decoration: none"><i class="fa fa-home"></i> Số 1 Đại Cồ Việt Trường BKHN</a></li>
                    <li><a style="text-decoration: none"><i class="fa fa-phone"></i> 0163 816 1533 </a></li>
                </ul>
            </div>
